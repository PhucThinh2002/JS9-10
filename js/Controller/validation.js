// validate trống 
export const requiredValidate = (string,selector,message) =>  {
    if(string.trim() === ""){
...
export const lengthValidate = (string,selector,message) => {
    const regex = /^.{4,6}$/;
...
export const kiemTraChuoiChuCai = (string,selector,message) => {
...
export const dinhDangEmail = (string,selector,message) => {
...
export const dinhDangMatkhau = (string,selector,message) => {
...
export const kiemTraLuongCB = (string,selector,message) => {
...
// Kiểm tra số giờ làm
export const kiemTraGioLam = (string,selector,message) => {
